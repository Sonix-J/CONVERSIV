...
export default function Home() {
  return (
    ...
    >
      <main className="relative flex flex-col p-8 md:p-20 justify-center items-center gap-8 min-h-screen z-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[#0C1A2B] text-white min-h-screen">
      ...
      <div className="flex justify-center items-center bg-[#0C1A2B] px-6 py-8 md:py-0">
        <SectionHeading text="Conversiv unifies your entire revenue flow into one AI-native system." />
      </div>
      <section className="flex flex-col justify-between px-6 md:px-12 py-16 md:py-32 bg-[#0C1A2B] text-white">
      ...
      <section className="flex flex-col justify-between px-6 md:px-12 py-16 md:py-32 gap-16 md:gap-32 bg-[#0C1A2B] text-white min-h-screen">
        <LayerRow
      ...
      <section className="flex flex-col px-6 md:px-12 py-16 md:py-32 gap-16 md:gap-32 bg-[#0C1A2B] text-white min-h-screen">
